...
@router.get('')
async def get_graphs(type: str = None, source: str = None, weather: str = None, location: str = None, start: str = None, end: str = None):
    ...
    weather_data = {}
    if weather and 'temperature' in weather.split(','):
        weather_data['temperature'] = [0.0 for _ in range(len(labels))]
    if weather and 'humidity' in weather.split(','):
        weather_data['humidity'] = [0.0 for _ in range(len(labels))]
