...
class PotholeService:
    ...
    def __init__(self, p_ids: Set[int], p_names: Dict[int, str], mqtt_producer: Producer):
        self.p_ids = p_ids
...
pothole = PotholeService({33, 34}, {33: 'SLP 33', 34: 'SLP 34'}, Producer())
pothole.check_potholes()
